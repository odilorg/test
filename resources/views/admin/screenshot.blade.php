                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        @endphp
                            ...
                            <tr>
                            @php
                                $fileFullUrl = '/admin/screenshot/'.$el;
                                $dateCreateFile = date('Y-m-d H:i:s', filemtime(public_path('admin/screenshot/'.$el)));
                            @endphp
                            <td>{{$i++}}</td>
                            <td>{{$dateCreateFile}}</td>
                            <td><a href="{{$fileFullUrl}}" target="_blank">{{$el}}</a></td>
                            <td><img width="30" height="30" src="{{$fileFullUrl}}" alt="{{$el}}"></td>
                        </tr>
                            @endforeach
                        </tbody>
                </table>
